 ...
 * @Version : 2.3
 *
 * Para que la directiva funcione y haga las respectivas validaciones es necesaria la eEmpleadota "validar"
 ...
 *
 * La eEmpleadota "validar" puede ser remplazada en el archivo input-mensaje-errores-contenedor.directive.ts
